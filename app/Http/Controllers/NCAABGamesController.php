...
class NCAABGamesController extends Controller
{
	...
	public function __construct()
	{
		...
		$this->client = new Client([
			...
			'headers' => [
				'Ocp-Apim-Subscription-Key' => '73835f68a0cf48ec98922a3440df81e0'
			]
		]);
	}
    ...
    public function gamesByDate($date = null)
    {
    	...
    	$requests = [
    		'teams' => $this->client->get('cbb/scores/json/teams'),
    		'games' => $this->client->get("cbb/scores/json/GamesByDate/{$date}", ['cache' => false])
    	];
